    ...
    <>
      <section className="py-[100px]">
        <div className="max-w-[1170px] mx-auto px-[15px]">
            ...
            <div className="flex flex-wrap -mx-[15px]">
              <div className="w-full md:w-2/3 px-[15px]">
                ...
                <div className="mt-[30px] overflow-hidden flex flex-wrap items-center">
                  <Link to="/" className="text-brand text-[15px] font-orbitron font-bold uppercase mr-auto transition-colors hover:opacity-80">
                    Back to Gallery
                  </Link>
                  <a href="#" className="text-text-main text-[15px] font-orbitron font-bold uppercase ml-[20px] transition-colors hover:text-brand">
                    Previous
                  </a>
                  <a href="#" className="text-text-main text-[15px] font-orbitron font-bold uppercase ml-[20px] transition-colors hover:text-brand">
                    Next
          ...
          <div>
            <h2 className="text-[38px] leading-[48px] m-0 mb-[40px] text-center text-text-main font-rajdhani">Latest Projects</h2>
            <div className="flex flex-wrap -mx-[15px]">
              {[
