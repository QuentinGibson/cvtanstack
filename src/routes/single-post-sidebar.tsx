        ...
        <div className="max-w-[1170px] mx-auto px-[15px]">
          <div className="flex flex-wrap -mx-[15px]">
            <div className="w-full lg:w-3/4 px-[15px]">
                ...
                <div className="mb-[40px]">
                  ...
                  <div className="pt-[50px]">
                    <div className="mb-[40px]">
                      ...
                      <h1 className="text-[30px] md:text-[40px] leading-[1.2] m-0 mb-[20px] pb-[20px] text-text-main font-rajdhani relative after:content-[''] after:absolute after:w-[170px] after:h-[1px] after:bg-border-med after:bottom-0 after:left-0">
                    ...
                    <div className="text-left">
                      <p className="text-[19px] leading-[26px] mb-[20px] text-text-main font-rajdhani">
                        Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker.
                      </p>
                      <p className="text-text-main text-[24px] leading-[36px] font-rajdhani italic pl-[30px] border-l-4 border-brand mb-[30px]">
                      ...
                      <div className="mt-[40px] pt-[20px] border-t border-border-light">
              ...
              <div className="mb-[70px]">
                <h2 className="text-[24px] font-rajdhani text-text-main mb-[30px]">Comments (2)</h2>
              ...
              <div>
                <h2 className="text-[24px] font-rajdhani text-text-main mb-[30px]">Leave a Comment</h2>
              ...
              <div className="lg:pl-[20px]">
                <div className="mb-[50px] relative">
                  <form className="relative">
                    <input type="search" placeholder="Search..." className="w-full py-[12px] px-[20px] pr-[50px] border border-border-light outline-none text-text-main text-[14px] font-orbitron italic transition-colors focus:border-brand" />
                    <button type="submit" className="absolute top-0 right-0 w-[50px] h-full bg-transparent border-none outline-none text-text-main cursor-pointer hover:text-brand transition-colors">
                      <i className="fa fa-search"></i>
                    </button>
                  </form>
                </div>
                <div className="mb-[50px]">
                  <h2 className="text-[21px] font-rajdhani text-text-main mb-[25px] pb-[12px] relative after:content-[''] after:absolute after:w-[30px] after:h-[1px] after:bg-border-med after:bottom-0 after:left-0">About me</h2>
                  <p className="text-[17px] leading-[26px] text-text-main font-rajdhani m-0">
                ...
                <div className="mb-[50px]">
                  <h2 className="text-[21px] font-rajdhani text-text-main mb-[25px] pb-[12px] relative after:content-[''] after:absolute after:w-[30px] after:h-[1px] after:bg-border-med after:bottom-0 after:left-0">Recent Posts</h2>
                  <ul className="m-0 p-0 list-none">
                    {[
                      ...
                      <li key={i} className="flex mb-[20px] last:mb-0">
                        ...
                        <div>
                          <h2 className="text-[18px] leading-[24px] font-rajdhani m-0 mb-[5px]">
                            <a href="/single-post" className="text-text-main hover:text-brand transition-colors">{post.title}</a>
                          </h2>
                          <span className="text-text-muted text-[12px] font-orbitron font-semibold uppercase">{post.date}</span>
                        </div>
                      </li>
                    ))}
                  </ul>
                ...
                <div className="mb-[50px]">
                  <h2 className="text-[21px] font-rajdhani text-text-main mb-[25px] pb-[12px] relative after:content-[''] after:absolute after:w-[30px] after:h-[1px] after:bg-border-med after:bottom-0 after:left-0">Social Networks</h2>
                  <ul className="m-0 p-0 list-none flex flex-wrap -mx-[2px]">
                    {['facebook', 'twitter', 'dribbble', 'github-alt', 'vimeo', 'youtube-play'].map(social => (
                      <li key={social} className="px-[2px] mb-[4px]">
                        <a href="#" className="w-[38px] h-[38px] leading-[38px] text-center inline-block text-white bg-text-main hover:bg-brand transition-colors">
                          <i className={`fa fa-${social}`}></i>
                        </a>
                      </li>
                    ))}
                ...
                <div className="mb-[50px]">
                  <h2 className="text-[21px] font-rajdhani text-text-main mb-[25px] pb-[12px] relative after:content-[''] after:absolute after:w-[30px] after:h-[1px] after:bg-border-med after:bottom-0 after:left-0">Tags</h2>
                  <ul className="m-0 p-0 list-none flex flex-wrap">
                    {['design', 'development', 'travelling', 'nature', 'web design', 'multimedia', 'graphics'].map(tag => (
                      <li key={tag} className="mr-[5px] mb-[5px]">
                        <a href="#" className="inline-block px-[15px] py-[6px] border border-border-light text-text-muted text-[13px] font-orbitron hover:border-brand hover:text-brand transition-colors">
                          {tag}
                        </a>
                      </li>
                    ))}
                ...
                <div className="mb-[50px]">
                  <h2 className="text-[21px] font-rajdhani text-text-main mb-[25px] pb-[12px] relative after:content-[''] after:absolute after:w-[30px] after:h-[1px] after:bg-border-med after:bottom-0 after:left-0">Newsletter</h2>
                  <p className="text-[17px] leading-[26px] text-text-main font-rajdhani mb-[15px]">
                    Subscribe to our newsletter and stay up to date with coming events straight in your mailbox:
                  </p>
                  <form className="relative">
                    <input type="text" name="sub-email" id="sub-email" placeholder="youremail@mail.com..." className="w-full py-[12px] px-[20px] pr-[50px] border border-border-light outline-none text-text-main text-[14px] font-orbitron transition-colors focus:border-brand" />
                    <button type="submit" className="absolute top-0 right-0 w-[50px] h-full bg-text-main text-white border-none outline-none cursor-pointer hover:bg-brand transition-colors">
                      <i className="fa fa-check"></i>
                    </button>
                  </form>
                </div>
                <div className="mb-[50px]">
                  <h2 className="text-[21px] font-rajdhani text-text-main mb-[25px] pb-[12px] relative after:content-[''] after:absolute after:w-[30px] after:h-[1px] after:bg-border-med after:bottom-0 after:left-0">Categories</h2>
                  <ul className="m-0 p-0 list-none">
                    {[
                      ...
                      <li key={cat.name} className="mb-[10px] last:mb-0">
                        <a href="#" className="flex justify-between items-center text-text-main text-[17px] font-rajdhani hover:text-brand transition-colors pb-[10px] border-b border-border-light border-dotted">
                          {cat.name} <span className="text-text-muted text-[14px] font-orbitron">({cat.count})</span>
                        </a>
                      </li>
                    ))}
                  </ul>
